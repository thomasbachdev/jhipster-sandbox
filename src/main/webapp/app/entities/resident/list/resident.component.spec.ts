...
describe('Resident Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'resident', component: ResidentComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to residentService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getResidentIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getResidentIdentifier).toHaveBeenCalledWith(entity);
