...
describe('Rappel e2e test', () => {
  ...
  const rappelSample = { date: '2022-11-20T13:34:46.239Z', description: 'Bike systematic' };
  ...
  describe('Rappel page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('edit button click should load edit Rappel page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('Rappel');
  ...
  describe('new Rappel page', () => {
    ...
    it('should create an instance of Rappel', () => {
      cy.get(`[data-cy="date"]`).type('2022-11-19T17:47').blur().should('have.value', '2022-11-19T17:47');

      cy.get(`[data-cy="description"]`).type('protocol Rubber functionalities').should('have.value', 'protocol Rubber functionalities');
